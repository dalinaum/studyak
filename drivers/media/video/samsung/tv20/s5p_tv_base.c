...
{
	printk("HDMI Power Management : phy power %s !!\n", on ? "on":"off");
	if (on) {
            __s5p_tv_poweron();
		/* on */
...
extern void hkdkc110_audio_tvout(bool tvout);

bool get_hdmi_onoff_status(void)
{
	return s5ptv_status.hpd_status;
}
