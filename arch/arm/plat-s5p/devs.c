...
#include <linux/usb/android_composite.h>
	...
	#if defined(CONFIG_KEYPAD_X10)
		#define HKDKC110_VENDOR_ID		0x18d1
		#define HKDKC110_PRODUCT_ID		0x0011
		#define HKDKC110_ADB_PRODUCT_ID	0x0012
	#else
		#define HKDKC110_VENDOR_ID		0x18d1
		#define HKDKC110_PRODUCT_ID		0x0001
		#define HKDKC110_ADB_PRODUCT_ID	0x0002
	#endif
#else
...
#if defined(CONFIG_HKDKC110_BOARD)
	{
		.product_id	= HKDKC110_PRODUCT_ID,
		.num_functions	= ARRAY_SIZE(usb_functions_ums),
		.functions	= usb_functions_ums,
	},
	{
		.product_id	= HKDKC110_ADB_PRODUCT_ID,
...
#if defined(CONFIG_HKDKC110_BOARD)
	#if defined(CONFIG_KEYPAD_X10)
		static char device_serial[MAX_USB_SERIAL_NUM]="1234567890ABCDEF";	//
	#else
		static char device_serial[MAX_USB_SERIAL_NUM]="BABABEEFBABABEEF";	//"Hardkernel",
	#endif
#else
...
#if defined(CONFIG_HKDKC110_BOARD)
	.vendor_id		= HKDKC110_VENDOR_ID,
	.product_id		= HKDKC110_PRODUCT_ID,
	#if defined(CONFIG_KEYPAD_X10)
		.manufacturer_name	= "viliv",	
		.product_name		= "viliv",	
	#else
		.manufacturer_name	= "Odroid",	//"Hardkernel",
		.product_name		= "Odroid",	//"HKDKC110",
	#endif
#else
...
static struct usb_mass_storage_platform_data ums_pdata = {
		...
		.product		= "X-10 Disk    ",	
	#else
		.vendor			= "HKDKC110  ",		//"Hardkernel",
		.product		= "Odroid Disk  ",	//"HKDKC110",
	#endif
#else
