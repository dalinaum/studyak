...
static int wm8991_digital_mute(struct snd_soc_dai *dai, int mute)
{
...
//			wm8991_write(codec, WM8991_ANTIPOP2, WM8991_BUFIOEN);
		...
		else
		{
			...
			val = wm8991_read_reg_cache(codec, WM8991_POWER_MANAGEMENT_1);
			wm8991_write(codec, WM8991_POWER_MANAGEMENT_1, val|0x13);
//			wm8991_write(codec, WM8991_POWER_MANAGEMENT_1, 0x13);
...
static struct snd_soc_dai_ops wm8991_dai_ops = {
